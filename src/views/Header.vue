<template>
  <div id="appheader">
    ...
    <div id="search" class="search__container">
          <input type="text" class="input__field" @keyup.enter="getSearch" v-model='search' placeholder="Pretražite...">
      </div>
        <div @click='getSearch' class="button"><i class="fas fa-search"></i></div>
  </div>
</template>
...
.input__field{
    margin: 0 20px;
    border: 5px solid rgba(221, 231, 252, 0.623);
    border-radius: 10px;
